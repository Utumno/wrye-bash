...
class _ANpcTweak(_AActorTweak):
    ...
    _player_fid = (CIstr(bush.game.master_file), 0x000007)
...
class RedguardNPCPatcher(_ANpcTweak):
    ...
    tweak_choices = [(u'1.0', u'1.0')]
    _redguard_fid = (CIstr(bush.game.master_file), 0x00000D43)
...
class AsIntendedImpsPatcher(_ACreatureTweak):
    ...
    _imp_spell = (CIstr(bush.game.master_file), 0x02B53F)
...
class AsIntendedBoarsPatcher(_ACreatureTweak):
    ...
    _boar_spell = (CIstr(bush.game.master_file), 0x02B54E)
